...
(function(){
  ...
  var quicklinksObject, prototype, svgAssets;
  ...
  function quicklinksInit(color){
    //create a new prototype for our quicklinks object
    //quicklinksCreatePrototype();
